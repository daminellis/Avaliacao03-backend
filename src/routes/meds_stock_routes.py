...
def meds_stock(app):
    ...
    @app.route('/updatemedsstock/<int:meds_stock_id>', methods=['PUT'])
    ...
    @app.route('/deletemedsstock/<int:meds_stock_id>', methods=['DELETE'])
