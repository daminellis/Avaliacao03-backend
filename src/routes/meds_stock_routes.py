...
def meds_stock(app):
    ...
    @app.route('/create/medstock', methods=['POST'])
    ...
    @app.route('/update/meds-stock/<int:meds_stock_id>', methods=['PUT'])
    ...
    @app.route('/delete/meds-stock/<int:meds_stock_id>', methods=['DELETE'])
